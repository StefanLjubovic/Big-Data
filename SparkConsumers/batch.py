...
if __name__ == '__main__':
    ...
    spark = SparkSession\
        .builder\
        .appName("BatchToCurated")\
        .getOrCreate()


    df = spark.read.json(HDFS_NAMENODE + "/transformation/reviews.json")
    movie_df = spark.read.json(HDFS_NAMENODE + "/transformation/IMDB_movie_details.json")
